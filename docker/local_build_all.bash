...
(cd ./build_trainer && docker rmi -f ${trainer_image} && bash build_image.sh ${base_image} ${trainer_image})

server_image=${prefix_tag}ner-${arch}:${version}
(cd ./build_server && docker rmi -f ${server_image} && bash build_image.sh ${base_image} ${server_image})